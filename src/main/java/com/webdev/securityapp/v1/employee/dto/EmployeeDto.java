...
public class EmployeeDto {
    ...
    public EmployeeDto(Long id, String login, String password, Long role_id, Long last_action_id, LocalDateTime created_at, LocalDateTime last_login, Boolean is_deleted) {
        this.id = id;
        this.login = login;
